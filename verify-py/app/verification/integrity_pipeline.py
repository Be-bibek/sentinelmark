...
def _build_and_persist(
    *,
    ...
    telemetry_repo.persist_verdict(
        ...
        prev_hash=event.prev_hash,
        cpu_usage=event.payload.behavior_snapshot.cpu_usage_pct_x100,
        memory_usage=event.payload.behavior_snapshot.physical_memory_bytes,
        timing_jitter=event.payload.behavior_snapshot.jitter_ns,
        thread_count=event.payload.behavior_snapshot.thread_count,
        trust_score=trust,
        replay_detected=replay_detected,
