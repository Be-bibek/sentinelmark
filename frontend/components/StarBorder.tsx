...
const StarBorder = <T extends React.ElementType = 'div'>({
  ...
  return (
    ...
    >
      ...
      ></div>
      <div className="relative z-10 w-full h-full rounded-[24px] flex flex-col pointer-events-none">
        <div className="pointer-events-auto flex-1 w-full h-full flex flex-col">
          {children}
        </div>
      </div>
    </Component>
